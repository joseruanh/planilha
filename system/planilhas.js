function planilha17()
{
    let pickles = {pt1: 'PNG', pt2: 'FUR', pt3: 'LIB', pt4: 'RED', pt5: 'NET', pontos:'1 ponto'};
    let ruanh = {pt1: 'PNG', pt2: 'FUR', pt3: 'LIB', pt4: 'RED', pt5: 'LLL', pontos:'1 ponto'};
    let relampago = {pt1: 'PNG', pt2: 'FUR', pt3: 'LIB', pt4: 'RED', pt5: 'LLL', pontos:'1 ponto'};
    let victor = {pt1: 'RNG', pt2: 'KBM', pt3: 'LIB', pt4: 'RED', pt5: 'NET', pontos:'1 ponto'};
    let jean = {pt1: 'PNG', pt2: 'KBM', pt3: 'LIB', pt4: 'RED', pt5: 'LLL', pontos:'2 pontos'};
    let brener = {pt1: 'RNG', pt2: 'KBM', pt3: 'LIB', pt4: 'RED', pt5: 'LLL', pontos:'1 ponto'};
    let kennyd = {pt1: 'PNG', pt2: 'FUR', pt3: 'LIB', pt4: 'RED', pt5: 'LLL', pontos:'1 ponto'};
    let vitor = {pt1: 'PNG', pt2: 'FUR', pt3: 'LIB', pt4: 'RED', pt5: 'LLL', pontos:'1 ponto'};
    ...
    <p><strong>RODADA 17</strong></p>
            ...
            <tr>
                <td class="nomes"> <strong> Ademiro </strong> <td id="loss">${victor.pt1}</td> <td id="win">${victor.pt2}</td> <td>${victor.pt3}</td> <td>${victor.pt4}</td> <td>${victor.pt5}</td> <td class="nomes"> <strong> ${victor.pontos} </strong> </td>
            </tr>
            ...
            <tr>
                <td class="nomes"> <strong> Brener </strong> <td id="loss">${brener.pt1}</td> <td id="win">${brener.pt2}</td> <td>${brener.pt3}</td> <td>${brener.pt4}</td> <td>${brener.pt5}</td> <td class="nomes"> <strong> ${brener.pontos} </strong> </td>
            </tr>
            ...
            <tr>
                <td class="nomes"> <strong> Vitor </strong> <td id="win">${vitor.pt1}</td> <td id="loss">${vitor.pt2}</td> <td>${vitor.pt3}</td> <td>${vitor.pt4}</td> <td>${vitor.pt5}</td> <td class="nomes"> <strong> ${vitor.pontos} </strong> </td>
            </tr>
