function planilha8()
{
    let pickles = {pt1: 'LIB', pt2: 'KBM', pt3: 'LLL', pt4: 'RED', pt5: 'PNG', pontos:'3 pontos'};
    let ruanh = {pt1: 'LIB', pt2: 'FUR', pt3: 'LLL', pt4: 'RED', pt5: 'PNG', pontos:'4 pontos'};
    let relampago = {pt1: 'LIB', pt2: 'FUR', pt3: 'LLL', pt4: 'RED', pt5: 'PNG', pontos:'4 pontos'};
    let victor = {pt1: 'NA', pt2: 'KBM', pt3: 'LLL', pt4: 'RED', pt5: 'RNG', pontos:'3 pontos'};
    let jean = {pt1: 'LIB', pt2: 'KBM', pt3: 'LLL', pt4: 'RED', pt5: 'PNG', pontos:'3 pontos'};
    let brener = {pt1: 'FLA', pt2: 'FUR', pt3: 'LLL', pt4: 'RED', pt5: 'RNG', pontos:'3 pontos'};
    let tony = {pt1: 'NA', pt2: 'NA', pt3: 'NA', pt4: 'NA', pt5: 'pt5', pontos:'0 pontos'};
    let kennyd = {pt1: 'FLA', pt2: 'FUR', pt3: 'LLL', pt4: 'RED', pt5: 'PNG', pontos:'3 pontos'};
    ...
    <p><strong>RODADA 8</strong></p>
            ...
            <tr>
                <td class="nomes"> <strong> Relâmpago </strong> <td id="win">${relampago.pt1}</td> <td id="win">${relampago.pt2}</td> <td id="win">${relampago.pt3}</td> <td id="win">${relampago.pt4}</td> <td>${relampago.pt5}</td> <td class="nomes"> <strong> ${relampago.pontos} </strong> </td>
            </tr>

            <tr>
                <td class="nomes"> <strong> Victor </strong> <td id="loss">${victor.pt1}</td> <td id="loss">${victor.pt2}</td> <td id="win">${victor.pt3}</td> <td id="win">${victor.pt4}</td> <td>${victor.pt5}</td> <td class="nomes"> <strong> ${victor.pontos} </strong> </td>
            </tr>

            <tr>
                <td class="nomes"> <strong> Jean </strong> <td id="win">${jean.pt1}</td> <td id="loss">${jean.pt2}</td> <td id="win">${jean.pt3}</td> <td id="win">${jean.pt4}</td> <td>${jean.pt5}</td> <td class="nomes"> <strong> ${jean.pontos} </strong> </td>
            </tr>
            ...
            <tr>
                <td class="nomes"> <strong> Kennyd </strong> <td id="loss">${kennyd.pt1}</td> <td id="win">${kennyd.pt2}</td> <td id="win">${kennyd.pt3}</td> <td id="win">${kennyd.pt4}</td> <td>${kennyd.pt5}</td> <td class="nomes"> <strong> ${kennyd.pontos} </strong> </td>
            </tr>
