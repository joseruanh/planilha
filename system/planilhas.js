function planilha18()
{
    let pickles = {pt1: 'LIB', pt2: 'RNG', pt3: 'NET', pt4: 'KBM', pt5: 'RED', pontos:'0 pontos'};
    let ruanh = {pt1: 'LIB', pt2: 'LLL', pt3: 'FUR', pt4: 'KBM', pt5: 'PNG', pontos:'0 pontos'};
    let relampago = {pt1: 'LIB', pt2: 'LLL', pt3: 'FUR', pt4: 'KBM', pt5: 'PNG', pontos:'0 pontos'};
    let victor = {pt1: 'ITZ', pt2: 'LLL', pt3: 'NET', pt4: 'KBM', pt5: 'RED', pontos:'0 pontos'};
    let jean = {pt1: 'LIB', pt2: 'LLL', pt3: 'FUR', pt4: 'KBM', pt5: 'PNG', pontos:'0 pontos'};
    let brener = {pt1: 'ITZ', pt2: 'LLL', pt3: 'NET', pt4: 'KBM', pt5: 'RED', pontos:'0 pontos'};
    let vitor = {pt1: 'pt1', pt2: 'pt2', pt3: 'pt3', pt4: 'pt4', pt5: 'pt5', pontos:'0 pontos'};
    let kennyd = {pt1: 'LIB', pt2: 'LLL', pt3: 'FUR', pt4: 'KBM', pt5: 'PNG', pontos:'0 pontos'};
    ...
    <p><strong>RODADA 8</strong></p>
            ...
            <tr>
                <td class="nomes"> <strong> Ademiro </strong> <td>${victor.pt1}</td> <td>${victor.pt2}</td> <td>${victor.pt3}</td> <td>${victor.pt4}</td> <td>${victor.pt5}</td> <td class="nomes"> <strong> ${victor.pontos} </strong> </td>
            </tr>
            ...
            <tr>
                <td class="nomes"> <strong> Victor </strong> <td>${vitor.pt1}</td> <td>${vitor.pt2}</td> <td>${vitor.pt3}</td> <td>${vitor.pt4}</td> <td>${vitor.pt5}</td> <td class="nomes"> <strong> ${vitor.pontos} </strong> </td>
            </tr>
