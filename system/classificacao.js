var primeiro = {nome: 'Pickles', pontos: 27, posicao: 1};
var segundo = {nome: 'Jean', pontos: 27, posicao: 1};
var terceiro = {nome: 'Relâmpago', pontos: 27, posicao: 2};
var quarto = {nome:'Ruanh', pontos: 25, posicao: 3};
var quinto = {nome: 'Brener', pontos: 24, posicao: 4};
var sexto = {nome: 'Victor', pontos: 23, posicao: 4};
var setimo = {nome: 'Kennyd', pontos: 22, posicao: 5};
...
function cblol()
{
    ...
    <table class="classificacao">
            	...
            	<tr>
            		<td> <h1>6</h1> </td> <td> <img class="imgLogo1" src="../logos/net.png"> </td> <td>3v - 5d</td>
            	</tr>
                ...
                <tr>
                    <td> <h1>9</h1> </td> <td> <img class="imgLogo1" src="../logos/itz.png"> </td> <td>2v - 6d</td>
                </tr>

            	<tr>
            		<td> <h1>9</h1> </td> <td> <img class="imgLogo1" src="../logos/fla.png"> </td> <td>2v - 6d</td>
            	</tr>
